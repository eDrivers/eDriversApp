...
df[1,] <- c("Climate",
            ...
            "2018",
            '\\(\\Omega\\) \\(Aragonite\\)',
            "Starr, M. (2019a). Reference to come, aragonite and hypoxia.",
...
df[3,] <- c("Climate",
            ...
            "Galbraith, P. S., Chassé, J., Caverhill, C., Nicot, P., Gilbert, D., Lefaivre, D., et al. (2018). Physical Oceanographic Conditions in the Gulf of St. Lawrence during 2017. Department of Fisheries; Oceans Available at: http://www.dfo-mpo.gc.ca/csas-sccs/Publications/ResDocs-DocRech/2018/2018_050-fra.html [Accessed November 26, 2018].",
...
df[7,] <- c("Climate",
            ...
            "1992-2012",
            "\\(mm\\)",
            "Halpern, B. S., Frazier, M., Potapenko, J., Casey, K. S., Koenig, K., Longo, C., et al. (2015). Cumulative human impacts: Raw stressor data (2008 and 2013). KNB Data Repository doi:10.5063/f1s180fs.",
...
df[14,] <- c("Coastal",
             ...
             "NA",
             "\\(Expert\\) \\(based\\)",
             "Starr, M. (2019b). Reference to come, toxic algae.",
